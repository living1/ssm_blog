...
<!-- 查询出待审核的评论state=0 -->
<table class="easyui-datagrid" id="dg" title="评论管理" fitColumns="true" pagination="true"
 rownumbers="true" url="${pageContext.request.contextPath }/admin/comment/list.do" fit="true" toolbar="#tb"><!-- 这里是引用id是tb的模块作为工具栏 -->
 	<thead>
 		<tr>
 		<!-- field对应后台,这个属性的名字一定要和后台的json相对应，因为到时候会自动匹配 -->
 			...
 			<th field="content" width="50px" align="center" formatter="formatState">评论状态</th>
 		</tr>
 	</thead>
 </table>
